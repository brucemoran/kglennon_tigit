...
suppressMessages(plotExps(log2tpms = log2tpms, genes = unlist(head(TIGIT_High_vs_Low_tb$Name)), mapgenes = NULL, conds = metadata_ns_ov, condcol = "NM_173799_TIGIT_group", factors = c("High", "Low"), tag = "Median TIGTI High - Low log2TPM - EGAD00010001515"))
```
